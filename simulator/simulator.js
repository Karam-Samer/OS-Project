...
function load(n){
  const sc={
    basic:   [{id:'P1',at:0,bt:6},{id:'P2',at:1,bt:4},{id:'P3',at:2,bt:2},{id:'P4',at:3,bt:8},{id:'P5',at:4,bt:3}],
    shortjob:[{id:'P1',at:0,bt:1},{id:'P2',at:0,bt:2},{id:'P3',at:0,bt:1},{id:'P4',at:1,bt:3},{id:'P5',at:2,bt:1}],
    fairness:[{id:'P1',at:0,bt:10},{id:'P2',at:1,bt:2},{id:'P3',at:2,bt:4},{id:'P4',at:3,bt:1},{id:'P5',at:4,bt:6}],
    longjob: [{id:'P1',at:0,bt:15},{id:'P2',at:1,bt:2},{id:'P3',at:2,bt:3},{id:'P4',at:5,bt:1}],
  };
  procs=sc[n].map(p=>({...p}));renderList();
  document.getElementById('run-err').classList.remove('show');
}
